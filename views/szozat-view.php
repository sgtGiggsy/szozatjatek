...
?><div class="jatek" id="jatekter">
    ...
    ?></table>
    <button id="beKuld" onclick="sendMegoldas()" disabled>Beküld</button>
...
<!--
<div id="jatekinfo">
    <div id="jatekinfo_1">Játékos: <span id="jatekosnev"></span></div>
    <div id="jatekinfo_2">Szózat: <span id="szoveg"></span></div>
    <div id="jatekinfo_3">Helyes válaszok száma: <span id="helyesvalaszokszama"></span></div>
    <div id="jatekinfo_4">Hibás válaszok száma: <span id="hibasvalaszokszama"></span></div>
    <div id="jatekinfo_5">Játék állapota: <span id="jatekallapot"></span></div>
